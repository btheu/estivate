...
public class EstivateMapper {
	...
	private static <T> void setValueToTarget(Document document, Elements elementsIn, T target, AccessibleObject member,
		...
		try {
			...
			Object[] values = prepareArgumentValues(document, elementsIn, member, valuesIn);
	 ...
	 */
	protected static void setValue(Document document, Elements element, Object target, Field field, Object value)
	...
	protected static void setValue(Document document, Elements element, Object target, Method method, Object... values)
